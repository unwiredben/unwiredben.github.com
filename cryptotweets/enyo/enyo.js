...
return function() {
if (this._constructor) var a = this._constructor.apply(this, arguments);
...
if (a.isOverscrolling()) {
var h = a.getOverScrollBounds()["over" + c];
f = Math.abs(h), g = Math.max(h, 0);
}
...
enyo.platform.ios && this.accel && (a += " enyo-composite"), this.container.addClass(a), this.translation = this.accel ? "translate3d" : "translate";
},
initComponents: function() {
...
drag: function(a, b) {
this.dragging && (b.preventDefault(), this.$.scrollMath.drag(b));
},
dragfinish: function(a, b) {
...
maxHeightChanged: function() {
this.$.client.applyStyle("max-height", this.maxHeight), this.$.clientContainer.addRemoveClass("enyo-scrollee-fit", !this.maxHeight);
},
shouldDrag: function(a, b) {
